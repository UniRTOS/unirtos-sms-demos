...
This demo demonstrates SMS management on UniRTOS, covering PDU/Text format send/receive, storage management, asynchronous result handling, and status-driven message processing.

- Demonstrates SMS send, read, delete, and list operations in both PDU and Text format
- Demonstrates SMS memory storage configuration: mem1/mem2/mem3 for read, write, and receive respectively
- Demonstrates SMS init status event handling via message queue and event callback
- Demonstrates asynchronous SMS operation result processing with dedicated message type dispatch
- Demonstrates SIM-aware SMS configuration for multi-SIM scenarios
